 ...
 * @author LQ
 * @date 2014年12月23日 11:46
 */
public class MxPreferencesHelper {
	...
	public MxPreferencesHelper(SharedPreferences preferences){
		mSharedPreferences = preferences;
		mEditor = mSharedPreferences.edit();
	}
	
	public MxPreferencesHelper(Context context){
		mSharedPreferences = context.getSharedPreferences(context.getPackageName(), Context.MODE_APPEND);
		mEditor = mSharedPreferences.edit();
	}
	
	public MxPreferencesHelper(Context context, String fileName){
