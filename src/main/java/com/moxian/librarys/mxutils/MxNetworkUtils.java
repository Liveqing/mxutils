 ...
 * 
 * @author LQ
 * @date 2014年12月23日 11:09 
 */
public class MxNetworkUtils {
	private Context context;
	private static final String TAG = Network.class.getSimpleName();

	public MxNetworkUtils(Context context)
	{
	...
	public static boolean printNetworkInfo(Context context) {
		...
		if (connectivity != null) {
			...
			MxUtils.i(TAG, "-------------$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$-------------");
			MxUtils.i(TAG, "getActiveNetworkInfo: " + in);
			NetworkInfo[] info = connectivity.getAllNetworkInfo();
			if (info != null) {
				for (int i = 0; i < info.length; i++) {
					// if (info[i].getType() == ConnectivityManager.TYPE_WIFI) {
					MxUtils.i(TAG, "NetworkInfo[" + i + "]isAvailable : " + info[i].isAvailable());
					MxUtils.i(TAG, "NetworkInfo[" + i + "]isConnected : " + info[i].isConnected());
					MxUtils.i(TAG, "NetworkInfo[" + i + "]isConnectedOrConnecting : " + info[i].isConnectedOrConnecting());
					MxUtils.i(TAG, "NetworkInfo[" + i + "]: " + info[i]);
					// }
				}
				MxUtils.i(TAG, "\n");
			} else {
				MxUtils.i(TAG, "getAllNetworkInfo is null");
			}
		}
		return false;
	}
